...
SECRET_KEY = 'django-insecure-+ee19y7m!m3s*9r-azl_ib&fbtjuz9iipii-6t8l!ebr@rjzl='
...
INSTALLED_APPS = [
    ...
    'appointements.apps.AppointementsConfig',
...
DATABASES = {
    'default': {
        'ENGINE': 'mysql.connector.django',  # custom engine
